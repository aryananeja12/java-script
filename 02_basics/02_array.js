...
console.log(Array.from({name: "aryan"})); //construct array from array like object only 
...
console.log(Array.of(score1, score2, score3)); //represent new array from set of elements // kisi ko bhi array mein krdenga

console.log(Array.of({name: "Aryan"})); //[ { name: 'Aryan' } ]